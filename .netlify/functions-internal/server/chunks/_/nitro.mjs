...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "2e18de58-0c23-444d-b51a-f854ff658975",
...
const _lDK5C_Tqx8A_GU6f6eY1S_ewMKmll72mtqswlIKXy2w = defineNitroPlugin((nitroApp) => {
...
const plugins = [
  _lDK5C_Tqx8A_GU6f6eY1S_ewMKmll72mtqswlIKXy2w
];

const _lazy_b8QMCX = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_b8QMCX, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_b8QMCX, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, joinRelativeURL as a, useRuntimeConfig as b, getQuery as c, defineRenderHandler as d, createError$1 as e, getRouteRules as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, hasProtocol as k, isScriptProtocol as l, joinURL as m, normalizeCookieHeader as n, getContext as o, defu as p, createHooks as q, createRouter$1 as r, sanitizeStatusCode as s, toRouteMatcher as t, useNitroApp as u, getRequestHeaders as v, withQuery as w, parseQuery as x, withTrailingSlash as y, withoutTrailingSlash as z };
