import { inject as inject$1, getCurrentInstance as getCurrentInstance$1, warn, computed, isRef, createVNode, hasInjectionContext, toRef, shallowRef, ref, watch, nextTick, defineComponent as defineComponent$1, capitalize, h, camelize, provide, mergeProps, watchEffect, reactive, isVNode, Comment, Fragment, unref, resolveDynamicComponent, TransitionGroup, Transition, onScopeDispose, toRefs, readonly, toRaw, effectScope, version as version$1, Text, withDirectives, defineAsyncComponent, shallowReactive, Suspense, resolveDirective, Teleport, vShow, useSSRContext, createApp, withCtx, createTextVNode, createBlock, createCommentVNode, openBlock, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, isReactive, getCurrentScope, createElementBlock, createElementVNode } from 'vue';
import { w as withQuery, k as hasProtocol, l as isScriptProtocol, m as joinURL, s as sanitizeStatusCode, o as getContext, $ as $fetch, p as defu, q as createHooks, e as createError$1, t as toRouteMatcher, r as createRouter$1, v as getRequestHeaders } from '../_/nitro.mjs';
...
const _global = typeof globalThis !== "undefined" ? globalThis : typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : {};
...
const _globalThis = typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : typeof globalThis !== "undefined" ? globalThis : {};
...
const _routes = [
  {
    ...
    component: () => import('./account-settings-DVEYtzFy.mjs')
  },
  {
    name: "banking",
    path: "/banking",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./banking-DHrQdYzW.mjs')
  },
  {
    name: "cards",
    path: "/cards",
    component: () => import('./cards-D1ZtvHzn.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-BEOioHx8.mjs')
  },
  {
    name: "form-layouts",
    path: "/form-layouts",
    component: () => import('./form-layouts-C_6VfWC9.mjs')
  },
  {
    name: "icons",
    path: "/icons",
    component: () => import('./icons-DpxisML5.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./login-BCkrIZ2u.mjs')
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta || {},
    component: () => import('./register-CAfD0RIb.mjs')
  },
  {
    name: "tables",
    path: "/tables",
    component: () => import('./tables-B7XXI3nt.mjs')
  },
  {
    name: "typography",
    path: "/typography",
    component: () => import('./typography-C55D457H.mjs')
  }
];
...
const layouts = {
  ...
  "components-default-layout-with-vertical-nav": defineAsyncComponent(() => import('./DefaultLayoutWithVerticalNav-CUMQDawL.mjs')),
  "components-footer": defineAsyncComponent(() => import('./Footer-Cjp3StJ2.mjs')),
  "components-nav-items": defineAsyncComponent(() => import('./NavItems-BTUPZtlq.mjs')),
  "components-navbar-theme-switcher": defineAsyncComponent(() => import('./NavbarThemeSwitcher-vTz2vddq.mjs')),
  "components-user-profile": defineAsyncComponent(() => import('./UserProfile-COkgaQxc.mjs')),
  default: defineAsyncComponent(() => import('./default-Bg6R5IEM.mjs'))
};
...
export { useTheme as $, getCurrentInstance as A, clamp as B, defineFunctionalComponent as C, convertToUnit as D, consoleError as E, wrapInArray as F, deepEqual as G, getObjectValueByPath as H, IconValue as I, isEmpty as J, useLoader as K, useBackgroundColor as L, LoaderSlot as M, makeLoaderProps as N, makeDisplayProps as O, EventProp as P, getPropertyFromItem as Q, useRoute$1 as R, getUid as S, VImg as T, VCardItem as U, VCard as V, VCardTitle as W, VCardSubtitle as X, VCardActions as Y, VMenu as Z, _export_sfc as _, VCardText as a, VProgressCircular as a0, useTextColor as a1, forwardRefs as a2, omit as a3, makeVBtnProps as a4, animate as a5, standardEasing as a6, keys as a7, useGroup as a8, useGroupItem as a9, ensureValidVNode as aA, checkPrintable as aB, makeGroupProps as aC, useBorder as aD, useVariant as aE, useElevation as aF, useSize as aG, useLink as aH, genOverlays as aI, makeRouterProps as aJ, useGoTo as aK, focusableChildren as aL, defineComponent as aM, createSimpleFunctional as aN, deprecate as aO, focusChild as aP, makeVOverlayProps as aQ, VOverlay as aR, useRouter$1 as aS, useNuxtApp as aT, resolveRouteObject as aU, useRuntimeConfig as aV, navigateTo as aW, nuxtLinkDefaults as aX, useLocation as aY, makeLocationProps as aZ, pickWithRest as a_, useLazy as aa, makeLazyProps as ab, makeGroupItemProps as ac, MaybeTransition as ad, useDensity as ae, useScopeId as af, isObject as ag, breakpoints as ah, filterInputAttrs as ai, Ripple as aj, matchesSelector as ak, makeTransitionProps as al, getCurrentInstanceName as am, consoleWarn as an, useToggleScope as ao, only as ap, makeDimensionProps as aq, useDimension as ar, useRounded as as, nullifyTransforms as at, VDefaultsProvider as au, pick as av, Intersect as aw, callEvent as ax, debounce as ay, VDialogTransition as az, VAvatar as b, VBtn as c, VIcon as d, entry$1 as default, useLocale as e, useRtl as f, genericComponent as g, provideTheme as h, isOn as i, useDisplay as j, provideDefaults as k, useResizeObserver as l, createRange as m, useRender as n, makeVariantProps as o, propsFactory as p, makeThemeProps as q, makeTagProps as r, makeSizeProps as s, makeRoundedProps as t, useProxiedModel as u, makeElevationProps as v, makeDensityProps as w, makeComponentProps as x, makeBorderProps as y, keyValues as z };
